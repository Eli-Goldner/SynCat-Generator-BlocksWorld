    ...
    public class SynCat
    {
	 /*
        ...
        */
        ...
        // try with "never mind"
        public HashSet<string> sg_nouns = new HashSet<string>() { "bottle", "block", "box",
	    "mug", "cup", "knife", "plate", "one" };
        public HashSet<string> pl_nouns = new HashSet<string>() { "bottles", "blocks", "boxes",
	    "mugs", "cups", "knives", "plates", "ones" };
        ...
        public HashSet<string> adjectives = new HashSet<string>(){ "yellow", "red", "blue", "purple",
