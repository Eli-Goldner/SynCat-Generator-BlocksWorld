...
namespace SynCatGenerator
{
    ...
    {
	 /*
         * Align with Kirby vocab i.e.
         * 'go to' + NP (no NP for 'here' or 'there')'go here' 'go there' --forward --back 
         * 'turn left' ---right
         * 'find' + NP, (all are imperatives and don't subcat for NP or PP)'explore', 'patrol', stop
        */

        /* Make sure this aligns with MapTerms in NLUModule.cs */
        // add bottle
        // make sure aligns with  string[] knownNominals in NLUModule.cs

        // try with "never mind"
        public List<string> sg_nouns = new List<string>() { "bottle", "block", "box",
	    "mug", "cup", "knife", "plate", "one", "glass", "blog" };
        public List<string> pl_nouns = new List<string>() { "bottles", "blocks", "boxes",
	    "mugs", "cups", "knives", "plates", "ones", "glasses", "blogs" };
        ...
        public List<string> adjectives = new List<string>(){ "yellow", "red", "blue", "purple",
	    "green", "orange", "white", "gray", "black", "pink", "brown" };
        public List<string> shift = new List<string>() { "never mind", "wait" };
        public List<string> trans_no_goal = new List<string>() { "pick up", "lift", "grab", "grasp",
	    "take", "let go of", "ungrasp", "drop", "release", "find", "go to"  };
        public List<string> trans_goal = new List<string>() { "move", "put", "push", "pull", "slide",
	    "place", "shift", "scoot", "servo", "bring" };
        public List<string> prepositions = new List<string>(){ "on the left of", "on the right of",
	...
	public List<string> local_imperative = new List<string>() { "go there", "go here", "go forward",
